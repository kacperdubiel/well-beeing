...
public interface CommentService {
    ...
    Comment updateComment(long commentId, Comment comment, String updaterName) throws NotFoundException, ForbiddenException;
    boolean deleteComment(long commentId, String cancellerName) throws NotFoundException, ForbiddenException;
}
