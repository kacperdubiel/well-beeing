CREATE TABLE IF NOT EXISTS public.activity_goal (
    activity_goal_id bigint NOT NULL,
    goal_creation_date timestamp without time zone NOT NULL,
...
ALTER TABLE public.activity_goal OWNER TO wellbeeing;
...
ALTER TABLE public.activity_goal_activity_goal_id_seq OWNER TO wellbeeing;
...
CREATE TABLE IF NOT EXISTS public.ailment (
    id uuid NOT NULL,
    change_in_calories double precision,
    change_in_proteins_gram_per_kilogram double precision,
...
ALTER TABLE public.ailment OWNER TO wellbeeing;
...
CREATE TABLE IF NOT EXISTS public.ailment_nutrition_label (
    nutrition_label_id uuid NOT NULL,
    ailment_id uuid NOT NULL
);


ALTER TABLE public.ailment_nutrition_label OWNER TO wellbeeing;
...
CREATE TABLE IF NOT EXISTS public.ailment_sport_label (
    ailment_id uuid NOT NULL,
    sport_label_id bigint NOT NULL
);


ALTER TABLE public.ailment_sport_label OWNER TO wellbeeing;
...
CREATE TABLE IF NOT EXISTS public.comment (
    ...
    com_content character varying(255),
    commenter_id uuid,
    post_id bigint,
    is_deleted boolean
);
...
ALTER TABLE public.comment OWNER TO wellbeeing;
...
ALTER TABLE public.comment_comment_id_seq OWNER TO wellbeeing;
...
CREATE TABLE IF NOT EXISTS public.conversations (
    ...
    is_read_by_first_user boolean,
    is_read_by_second_user boolean,
    last_message_date timestamp without time zone,
    first_profile_profile_user_id uuid,
    second_profile_profile_user_id uuid
);


ALTER TABLE public.conversations OWNER TO wellbeeing;
...
CREATE TABLE IF NOT EXISTS public.diet (
    id uuid NOT NULL,
    connected_with_macros boolean,
    description character varying(255),
    name character varying(255)
);


ALTER TABLE public.diet OWNER TO wellbeeing;
...
CREATE TABLE IF NOT EXISTS public.diet_calc_meal_suggestions (
    id uuid NOT NULL,
    glycemic_index_level character varying(255),
...
ALTER TABLE public.diet_calc_meal_suggestions OWNER TO wellbeeing;
...
ALTER TABLE public.diet_nutrition_label OWNER TO wellbeeing;
...
ALTER TABLE public.dietician_profile OWNER TO wellbeeing;
...
CREATE TABLE IF NOT EXISTS public.dish (
    ...
    draft boolean,
    glycemic_index_level character varying(255),
    img_dish_path character varying(255),
    name character varying(255),
    recipe character varying(1000),
    creator_id uuid
);


ALTER TABLE public.dish OWNER TO wellbeeing;
...
ALTER TABLE public.dish_meal_type OWNER TO wellbeeing;
...
ALTER TABLE public.dish_nutrition_label OWNER TO wellbeeing;
...
ALTER TABLE public.dish_product_detail OWNER TO wellbeeing;
...
ALTER TABLE public.doctor_profile OWNER TO wellbeeing;
...
ALTER TABLE public.doctor_specialization OWNER TO wellbeeing;
...
ALTER TABLE public.doctors_specializations OWNER TO wellbeeing;
...
CREATE TABLE IF NOT EXISTS public.exercise (
    ...
    name character varying(255) NOT NULL,
    creator uuid,
    path_to_video_instruction character varying(255),
    is_deleted boolean
);


ALTER TABLE public.exercise OWNER TO wellbeeing;
...
ALTER TABLE public.exercise_exercise_id_seq OWNER TO wellbeeing;
...
ALTER TABLE public.exercise_in_training OWNER TO wellbeeing;
...
ALTER TABLE public.exercise_in_training_id_seq OWNER TO wellbeeing;
...
ALTER TABLE public.exercise_labels OWNER TO wellbeeing;
...
ALTER TABLE public.follow OWNER TO wellbeeing;
...
ALTER TABLE public.follow_follow_id_seq OWNER TO wellbeeing;
...
ALTER TABLE public.hibernate_sequence OWNER TO wellbeeing;
...
ALTER TABLE public.likes OWNER TO wellbeeing;
...
ALTER TABLE public.likes_like_id_seq OWNER TO wellbeeing;
...
ALTER TABLE public.measure_types OWNER TO wellbeeing;
...
CREATE TABLE IF NOT EXISTS public.measures (
    ...
    owner_profile_user_id uuid
);


ALTER TABLE public.measures OWNER TO wellbeeing;
...
ALTER TABLE public.messages OWNER TO wellbeeing;
...
ALTER TABLE public.nutrition_label OWNER TO wellbeeing;
...
ALTER TABLE public.nutrition_plan OWNER TO wellbeeing;
...
ALTER TABLE public.nutrition_plan_position OWNER TO wellbeeing;
...
CREATE TABLE IF NOT EXISTS public.opinion (
    ...
    opinion_content character varying(255),
    rating integer,
    giver_id uuid,
    receiver_id uuid,
    added_date timestamp without time zone,
...
ALTER TABLE public.opinion OWNER TO wellbeeing;
...
ALTER TABLE public.opinion_opinion_id_seq OWNER TO wellbeeing;
...
CREATE TABLE IF NOT EXISTS public.post (
    ...
    is_sharing boolean,
    post_content text,
    post_img_path character varying(255),
    creator_id uuid,
    original_post_id bigint,
    sharing_counter integer,
    original_nutrition_plan_id uuid,
    original_training_plan_id bigint
);


ALTER TABLE public.post OWNER TO wellbeeing;
...
ALTER TABLE public.post_post_id_seq OWNER TO wellbeeing;
...
CREATE TABLE IF NOT EXISTS public.product (
    id uuid NOT NULL,
    caffeine_per_hundred_grams double precision,
    calories_per_hundred_grams double precision,
    carbohydrates_per_hundred_grams double precision,
    cholesterol_per_hundred_grams double precision,
    fats_per_hundred_grams double precision,
    fiber_per_hundred_grams double precision,
    glycemic_index_level character varying(255),
    name character varying(255),
...
ALTER TABLE public.product OWNER TO wellbeeing;
...
CREATE TABLE IF NOT EXISTS public.product_macro_detail (
    id uuid NOT NULL,
    amount_of_element_per_hundred_grams double precision,
    measure_type character varying(255),
    detailed_macro_type character varying(255),
    product_id uuid
);


ALTER TABLE public.product_macro_detail OWNER TO wellbeeing;
...
CREATE TABLE IF NOT EXISTS public.product_mineral_detail (
    ...
    amount_of_element_per_hundred_grams double precision,
    measure_type character varying(255),
    mineral_type character varying(255),
    product_id uuid
);


ALTER TABLE public.product_mineral_detail OWNER TO wellbeeing;
...
CREATE TABLE IF NOT EXISTS public.product_vitamin_detail (
    ...
    amount_of_element_per_hundred_grams double precision,
    measure_type character varying(255),
    vitamin_type character varying(255),
    product_id uuid
);


ALTER TABLE public.product_vitamin_detail OWNER TO wellbeeing;
...
CREATE TABLE IF NOT EXISTS public.profile (
    esex character varying(255),
    birthday timestamp without time zone,
    description character varying(255),
    e_nutrition_tag character varying(255),
    e_sport_tag character varying(255),
    first_name character varying(255),
    last_name character varying(255),
    profile_img_path character varying(255),
...
ALTER TABLE public.profile OWNER TO wellbeeing;
...
CREATE TABLE IF NOT EXISTS public.profile_card (
    ...
    age integer,
    diet_goal character varying(255),
...
ALTER TABLE public.profile_card OWNER TO wellbeeing;
...
CREATE TABLE IF NOT EXISTS public.profile_card_ailment (
    ailment_id uuid NOT NULL,
    profile_card_id uuid NOT NULL
);


ALTER TABLE public.profile_card_ailment OWNER TO wellbeeing;
...
CREATE TABLE IF NOT EXISTS public.profile_connections (
    ...
    connected_with_profile_user_id uuid,
    profile_profile_user_id uuid
);


ALTER TABLE public.profile_connections OWNER TO wellbeeing;
...
CREATE TABLE IF NOT EXISTS public.profile_diet_calculation (
    id uuid NOT NULL,
    basic_metabolism double precision,
    bmi double precision,
    bmi_result_type character varying(255),
...
ALTER TABLE public.profile_diet_calculation OWNER TO wellbeeing;
...
ALTER TABLE public.report OWNER TO wellbeeing;
...
ALTER TABLE public.report_dish_detail OWNER TO wellbeeing;
...
CREATE TABLE IF NOT EXISTS public.report_exercise (
    id bigint NOT NULL,
    exercising_time timestamp without time zone,
    seconds integer,
    exercise_id bigint,
    report_id uuid
);
...
ALTER TABLE public.report_exercise OWNER TO wellbeeing;
...
ALTER TABLE public.report_product_detail OWNER TO wellbeeing;
...
CREATE TABLE IF NOT EXISTS public.report_training (
    id bigint NOT NULL,
    seconds integer,
    training_time timestamp without time zone,
    report_id uuid,
    training_id bigint
);


ALTER TABLE public.report_training OWNER TO wellbeeing;
...
CREATE TABLE IF NOT EXISTS public.role_request (
    role_req_id bigint NOT NULL,
    added_date timestamp without time zone,
    comment character varying(255),
    document_img_path character varying(255),
...
ALTER TABLE public.role_request OWNER TO wellbeeing;
...
ALTER TABLE public.role_request_role_req_id_seq OWNER TO wellbeeing;
...
ALTER TABLE public.sport_label OWNER TO wellbeeing;
...
ALTER TABLE public.sport_label_ailment OWNER TO wellbeeing;
...
ALTER TABLE public.sport_label_ailment_id_seq OWNER TO wellbeeing;
...
ALTER TABLE public.sport_label_sport_label_id_seq OWNER TO wellbeeing;
...
ALTER TABLE public.sport_report OWNER TO wellbeeing;
...
ALTER TABLE public.trainer_profile OWNER TO wellbeeing;
...
ALTER TABLE public.training OWNER TO wellbeeing;
...
ALTER TABLE public.training_plan OWNER TO wellbeeing;
...
ALTER TABLE public.training_plan_request OWNER TO wellbeeing;
...
ALTER TABLE public.training_plan_training_plan_id_seq OWNER TO wellbeeing;
...
CREATE TABLE IF NOT EXISTS public.training_position (
    training_position_id bigint NOT NULL,
...
ALTER TABLE public.training_position OWNER TO wellbeeing;
...
ALTER TABLE public.training_position_training_position_id_seq OWNER TO wellbeeing;
...
ALTER TABLE public.training_training_id_seq OWNER TO wellbeeing;
...
ALTER TABLE public.user_roles OWNER TO wellbeeing;
...
ALTER TABLE public.wb_role OWNER TO wellbeeing;
...
ALTER TABLE public.wb_user OWNER TO wellbeeing;

--
-- Name: activity_goal activity_goal_id; Type: DEFAULT; Schema: public; Owner: wellbeeing
--

ALTER TABLE ONLY public.activity_goal ALTER COLUMN activity_goal_id SET DEFAULT nextval('public.activity_goal_activity_goal_id_seq'::regclass);
...
ALTER TABLE ONLY public.exercise_in_training ALTER COLUMN id SET DEFAULT nextval('public.exercise_in_training_id_seq'::regclass);
...
ALTER TABLE ONLY public.opinion ALTER COLUMN opinion_id SET DEFAULT nextval('public.opinion_opinion_id_seq'::regclass);
...
ALTER TABLE ONLY public.role_request ALTER COLUMN role_req_id SET DEFAULT nextval('public.role_request_role_req_id_seq'::regclass);
...
ALTER TABLE ONLY public.sport_label ALTER COLUMN sport_label_id SET DEFAULT nextval('public.sport_label_sport_label_id_seq'::regclass);
...
ALTER TABLE ONLY public.sport_label_ailment ALTER COLUMN id SET DEFAULT nextval('public.sport_label_ailment_id_seq'::regclass);
...
ALTER TABLE ONLY public.training_position ALTER COLUMN training_position_id SET DEFAULT nextval('public.training_position_training_position_id_seq'::regclass);