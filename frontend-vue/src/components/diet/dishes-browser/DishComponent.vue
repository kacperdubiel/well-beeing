        ...
        <table class="table table-borderless table-hover table-dish-info">
            ...
            <tbody>
                <tr>
                    ...
                    <td >{{Math.round(this.dish.derivedNutritionalValues.derivedProteins*100)/100}} g</td>
                </tr>
                <tr>
                    <th scope="row">Węglowodany</th>
                    <td>{{Math.round(this.dish.derivedNutritionalValues.derivedCarbohydrates*100)/100}} g</td>
                </tr>
                <tr>
                    <th scope="row">Cukry</th>
                    <td>{{Math.round(this.dish.derivedNutritionalValues.derivedSugar*100)/100}} g</td>
                </tr>
                <tr>
                    <th scope="row">Tłuszcze</th>
                    <td>{{Math.round(this.dish.derivedNutritionalValues.derivedFats*100)/100}} g</td>
                </tr>
                <tr>
                    <th scope="row">Tłuszcze nasycone</th>
                    <td>{{Math.round(this.dish.derivedNutritionalValues.derivedSaturatedFats*100)/100}} g</td>
                </tr>
                <tr>
                    <th scope="row">Cholesterol</th>
                    <td>{{Math.round(this.dish.derivedNutritionalValues.derivedCholesterol*1000)/1000}} g</td>
                </tr>
                <tr>
                    <th scope="row">Błonnik</th>
                    <td>{{Math.round(this.dish.derivedNutritionalValues.derivedFiber*100)/100}} g</td>
                </tr>
                <tr>
                    <th scope="row">Sól</th>
                    <td>{{Math.round(this.dish.derivedNutritionalValues.derivedSalt*100)/100}} g</td>
                </tr>
                <tr>
                    <th scope="row">Kofeina</th>
                    <td>{{Math.round(this.dish.derivedNutritionalValues.derivedCaffeine*1000)/1000}} g</td>
                </tr>
            </tbody>
        </table>
        <hr class="hr-dish title-line"/>
